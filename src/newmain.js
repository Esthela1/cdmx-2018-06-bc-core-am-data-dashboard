  ...
  btnLima.addEventListener('click', () => {
    ...
    for (let i = 0; i < thirdLima.length; i++) {
      ...
      btnLimaThird.addEventListener('click', () => {
        ...
        thirdLimaStudents += `<p class= "name">${thirdLimaNames}</p>`;
        thirdLimaPercentages += `<p class= "percent">${thirdLimaCompletedPercent}%</p>`;
        thirdLimaDuration += `<p class="long">${thirdLimaProgramDuration}</p>`;
